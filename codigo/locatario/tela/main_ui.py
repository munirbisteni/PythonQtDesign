...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableLocatario = QTableWidget(self.centralwidget)
        if (self.tableLocatario.columnCount() < 2):
            self.tableLocatario.setColumnCount(2)
        __qtablewidgetitem = QTableWidgetItem()
        __qtablewidgetitem.setTextAlignment(Qt.AlignCenter);
        self.tableLocatario.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.tableLocatario.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        self.tableLocatario.setObjectName(u"tableLocatario")
        self.tableLocatario.setGeometry(QRect(90, 161, 591, 161))
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem = self.tableLocatario.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"C\u00f3digo", None));
        ___qtablewidgetitem1 = self.tableLocatario.horizontalHeaderItem(1)
